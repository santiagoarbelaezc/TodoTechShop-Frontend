...
@Component({
  selector: 'app-carrusel-gaming',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './carrusel-gaming.component.html',
  styleUrls: ['./carrusel-gaming.component.css']
})
export class CarruselGamingComponent implements AfterViewInit {
